...
import os
import sys
# Add the parent directory to Python path to allow importing MMPolymer
...
def main(args):
    # Import MMPolymer in each spawned process to register tasks
    import MMPolymer
    import random
    import numpy as np
    ...
    # Use weights_only=False for PyTorch 2.6+ compatibility with older checkpoints
    ...
    # Set model to evaluation mode (disable dropout, use saved batch norm stats)
    model.eval()
